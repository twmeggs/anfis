...
anfis has a dependency on the scikit-fuzzy.  Unfortunately, as
scikit-fuzzy is not hosted on PyPI, this package cannot be auto-installed
as part of anfis's 'pip install'.  Therefore, please follow this sequence
of installation:
